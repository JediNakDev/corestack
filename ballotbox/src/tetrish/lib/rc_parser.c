 ...
 * src/tetrish/main.c. The behaviour is documented in rc_parser.h; the cases
 * are covered end to end by tests/test_shell.c, which drives the real binary
 * over a pipe rather than calling this function directly.
 *
